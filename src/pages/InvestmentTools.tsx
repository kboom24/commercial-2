...
export function InvestmentToolsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="bg-indigo-50 rounded-lg p-8">
        <h2 className="text-xl font-bold mb-4">Need Custom Analysis?</h2>
        <p className="text-gray-700 mb-6">
          Our team of investment analysts can help you with custom property analysis and portfolio strategies.
        </p>
